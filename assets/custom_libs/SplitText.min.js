...
var _gsScope = 'undefined' !== typeof module && module.exports && 'undefined' !== typeof global ? global : this || window;!(function (a) {
    'use strict';var b = a.GreenSockGlobals || a; var c = function (a) {
        var c; var d = a.split('.'); var e = b;for (c = 0;c < d.length;c++) {
            e[d[c]] = e = e[d[c]] || {};
        }

        return e;
    }; var d = c('com.greensock.utils'); var e = function (a) {
        var b = a.nodeType; var c = '';if (1 === b || 9 === b || 11 === b) {
        ...
        return c;
    }; var f = _gsScope.document || {}; var g = 'undefined' !== typeof a ? a : f.defaultView || {getComputedStyle:function () {}}; var h = function (a) {
        return g.getComputedStyle(a);
    }; var i = /([A-Z])/g; var j = function (a,b,c,d) {
        var e;
        ...
        var b; var c; var d; var e = []; var f = a.length;for (b = 0;f > b;b++) {
            if (c = a[b],k(c)) {
        ...
        for (var c,d = b.length;--d > -1;) {
            if (c = b[d],a.substr(0,c.length) === c) {
                return c.length;
            }
        }
    }; var n = /(?:\r|\n|\t\t)/g; var o = /(?:\s\s+)/g; var p = 55296; var q = 56319; var r = 56320; var s = 127462; var t = 127487; var u = 127995; var v = 127999; var w = function (a) {
        return (a.charCodeAt(0) - p << 10) + (a.charCodeAt(1) - r) + 65536;
    }; var x = f.all && !f.addEventListener; var y = ' style=\'position:relative;display:inline-block;' + (x ? '*display:inline;*zoom:1;\'' : '\''); var z = function (a,b) {
        a = a || '';var c = -1 !== a.indexOf('++'); var d = 1;

        return c && (a = a.split('++').join('')),function () {
            return '<' + b + y + (a ? ' class=\'' + a + (c ? d++ : '') + '\'>' : '>');
        };
    }; var A = d.SplitText = b.SplitText = function (a,b) {
        ...
        var d = a.nodeType;if (1 === d || 9 === d || 11 === d) {
            for (a = a.firstChild;a;a = a.nextSibling) {
                B(a,b,c);
            }
        } else {
        ...
        var b; var c = []; var d = a.length;for (b = 0;b !== d;c.push(a[b++])) {
            ;
        }
        ...
        var b; var c; var d = D(a.childNodes); var e = d.length;for (b = 0;e > b;b++) {
    ...
    }; var G = function (a,b,c,d,e,g,i) {
        var k; var l; var m; var n; var o; var p; var q; var r; var s; var t; var u; var v; var w = h(a); var x = j(a,'paddingLeft',w); var y = -999; var z = j(a,'borderBottomWidth',w) + j(a,'borderTopWidth',w); var A = j(a,'borderLeftWidth',w) + j(a,'borderRightWidth',w); var D = j(a,'paddingTop',w) + j(a,'paddingBottom',w); var G = j(a,'paddingLeft',w) + j(a,'paddingRight',w); var H = .2 * j(a,'fontSize'); var I = j(a,'textAlign',w,!0); var J = []; var K = []; var L = []; var M = b.wordDelimiter || ' '; var N = b.tag ? b.tag : b.span ? 'span' : 'div'; var O = b.type || b.split || 'chars,words,lines'; var P = e && -1 !== O.indexOf('lines') ? [] : null; var Q = -1 !== O.indexOf('words'); var R = -1 !== O.indexOf('chars'); var S = 'absolute' === b.position || b.absolute === !0; var T = b.linesClass; var U = -1 !== (T || '').indexOf('++'); var V = [];for (U && (T = T.split('++').join('')),l = a.getElementsByTagName('*'),m = l.length,o = [],k = 0;m > k;k++) {
            o[k] = l[k];
        } if (P || S) {
            for (k = 0;m > k;k++) {
        ...
        var g; var h; var i; var j; var k; var l; var r; var x; var y; var z; var A = b.tag ? b.tag : b.span ? 'span' : 'div'; var C = b.type || b.split || 'chars,words,lines'; var D = -1 !== C.indexOf('chars'); var E = 'absolute' === b.position || b.absolute === !0; var F = b.wordDelimiter || ' '; var G = ' ' !== F ? '' : E ? '&#173; ' : ' '; var H = '</' + A + '>'; var I = !0; var J = b.specialChars ? 'function' === typeof b.specialChars ? b.specialChars : m : null; var K = f.createElement('div'); var L = a.parentNode;for (L.insertBefore(K,a),K.textContent = a.nodeValue,L.removeChild(a),a = K,g = e(a),r = -1 !== g.indexOf('<'),b.reduceWhiteSpace !== !1 && (g = g.replace(o,' ').replace(n,'')),r && (g = g.split('<').join('{{LT}}')),k = g.length,h = (' ' === g.charAt(0) ? G : '') + c(),i = 0;k > i;i++) {
            if (l = g.charAt(i),J && (z = J(g.substr(i),b.specialChars))) {
                l = g.substr(i,z || 1),h += D && ' ' !== l ? d() + l + '</' + A + '>' : l,i += z - 1;
            } else if (l === F && g.charAt(i - 1) !== F && i) {
                for (h += I ? H : '',I = !1;g.charAt(i + 1) === F;) {
                    h += G,i++;
                }i === k - 1 ? h += G : ')' !== g.charAt(i + 1) && (h += G + c(),I = !0);
            } else {
                '{' === l && '{{LT}}' === g.substr(i,6) ? (h += D ? d() + '{{LT}}</' + A + '>' : '{{LT}}',i += 5) : l.charCodeAt(0) >= p && l.charCodeAt(0) <= q || g.charCodeAt(i + 1) >= 65024 && g.charCodeAt(i + 1) <= 65039 ? (x = w(g.substr(i,2)),y = w(g.substr(i + 2,2)),j = x >= s && t >= x && y >= s && t >= y || y >= u && v >= y ? 4 : 2,h += D && ' ' !== l ? d() + g.substr(i,j) + '</' + A + '>' : g.substr(i,j),i += j - 1) : h += D && ' ' !== l ? d() + l + '</' + A + '>' : l;
            }
        }a.outerHTML = h + (I ? H : ''),r && B(L,'{{LT}}','<');
    }; var I = function (a,b,c,d) {
        var e; var f; var g = D(a.childNodes); var h = g.length; var i = 'absolute' === b.position || b.absolute === !0;if (3 !== a.nodeType || h > 1) {
    ...
    }; var J = A.prototype;J.split = function (a) {
        this.isSplit && this.revert(),this.vars = a = a || this.vars,this._originals.length = this.chars.length = this.words.length = this.lines.length = 0;for (var b,c,d,e = this.elements.length,f = a.tag ? a.tag : a.span ? 'span' : 'div',g = z(a.wordsClass,f),h = z(a.charsClass,f);--e > -1;) {
